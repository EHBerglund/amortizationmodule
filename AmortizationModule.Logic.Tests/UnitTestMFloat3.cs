...
namespace AmortizationModule.Logic
{
    ...
    public class TestBondsFloat3
    {
        ...
        private AmortizationInput SetUpBondsFloat3()
        {
            ...
            {
                new Installment(new DateTime (2017,02,01), 1, new DateTime(2005,2,1)),
            };
            ...
            Input.AmortizationSecurity.InterestTerms = new Dictionary<DateTime, double>
            {
                ...
                {new DateTime (2011,02,01), 0.05},
                {new DateTime (2012,02,01), 0.05},
                {new DateTime (2013,02,01), 0.080219178},
                {new DateTime (2014,02,01), 0.08},
                {new DateTime (2015,02,01), 0.08},
                {new DateTime (2016,02,01), 0.08},
                {new DateTime (2017,02,01), 0.080219178},
            ...
            Input.AmortizationTransactions = new List<AmortizationTransaction>()
            {
                ...
                BuildHelper.Transaction("01.02.2011", 9, 1, "V-07", 5000, 1,7,"NOK", 1),
                BuildHelper.Transaction("01.02.2012", 9, 1, "V-08", 5000, 1,8,"NOK", 1),
                BuildHelper.Transaction("01.02.2013", 9, 1, "V-09", 8021.917808, 1,9,"NOK", 1),
                BuildHelper.Transaction("01.02.2014", 9, 1, "V-10", 8000, 1,10,"NOK", 1),
                BuildHelper.Transaction("01.02.2015", 9, 1, "V-11", 8000, 1,11,"NOK", 1),
                BuildHelper.Transaction("01.02.2016", 9, 1, "V-12", 8000, 1,12,"NOK", 1),
