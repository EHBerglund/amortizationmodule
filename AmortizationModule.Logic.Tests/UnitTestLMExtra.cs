    ...
    public class TestLoanExtra
    {
        ...
        private AmortizationInput SetUpLoanExtra()
        {
            ...
            Input.AmortizationSecurity.Instalments = new List<Installment>() {
                new Installment(new DateTime(2017,11,15), 0.0625, new DateTime(2017,8,15)),
                new Installment(new DateTime(2018,02,15), 0.0625, new DateTime(2017,8,15)),
                new Installment(new DateTime(2018,05,15), 0.0625, new DateTime(2017,8,15)),
                new Installment(new DateTime(2018,08,15), 0.0625, new DateTime(2017,8,15)),
                new Installment(new DateTime(2018,11,15), 0.0625, new DateTime(2017,8,15)),
                new Installment(new DateTime(2019,02,15), 0.0791666666666667, new DateTime(2019,2,15)),
                new Installment(new DateTime(2019,05,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2019,08,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2019,11,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2020,02,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2020,05,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2020,08,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2020,11,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2021,02,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2021,05,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2021,08,15), 0.0608333333333333, new DateTime(2019,2,15)),
                new Installment(new DateTime(2019,02,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2019,05,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2019,08,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2019,11,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2020,02,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2020,05,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2020,08,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2020,11,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2021,02,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2021,05,15), 0.0625, new DateTime(2017,8,15), false),
                new Installment(new DateTime(2021,08,15), 0.0625, new DateTime(2017,8,15), false),
             };
